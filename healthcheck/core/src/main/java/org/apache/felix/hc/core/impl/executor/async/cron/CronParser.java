...
/**
 * This is used to parse cron expressions.
 * <p>
 * 
 * The pattern comprises a list of six single space-separated fields: 
...
public final class CronParser {
    ...
    /**
     * Construct a {@link CronParser} from the pattern provided,
     ...
     */
    public CronParser(final String expression) {
     ...
     * @throws IllegalArgumentException if the pattern cannot be parsed
     */
    public CronParser(final String expression, final TimeZone timeZone) {
    ...
    public boolean equals(final Object other) {
        ...
        final CronParser otherCron = (CronParser) other;
